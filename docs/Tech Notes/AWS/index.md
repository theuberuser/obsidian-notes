...
- [AWS S3 Access Points - Easily manage access for shared datasets on Amazon S3](https://aws.amazon.com/s3/features/access-points/)
- [AWS ECS Express Mode](https://docs.aws.amazon.com/AmazonECS/latest/developerguide/express-service-overview.html)